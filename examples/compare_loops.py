...
for i in range(0, 6):
    ...
    sc_loops = []
    with open(("ringkey/withringkey_loops_in_" + args.seq + "_" + str(i) + ".txt")) as sc_00: # ha ringkey-es megoldásra szeretném futtatni
    #with open(("loops/loops_in_" + args.seq + "_" + str(i) + ".txt")) as sc_00:
    #with open(("binarization/loops/bin_loops_in_" + args.seq + "_" + str(i) + ".txt")) as sc_00:
    ...
    with open(("binarization/common_loops/bin_common_loops_" + args.seq + "_" + str(i) + ".txt"), 'w') as output:
        output.write(("Counter: " + str(counter)+ "\n"))
        for loop in common_loops:
            output.write(str(loop))
    #with open(("binarization/bin_median_all_info_common_loops_" + args.seq + ".txt"), 'a') as f:
    #with open(("info_common_loops_" + args.seq + ".txt"), 'a') as f:
    with open(("ringkey_info_common_loops_" + args.seq + ".txt"), 'a') as f:
        f.write(str(counter))
        f.write('\n')
