...
ground_truth_data = 309
sc_ringkey_input = "ringkey/info/info_02.txt"
sc_ringkey_common = "ringkey/info/info_common_loops_02.txt"
sc_ringkey_10_input = "ringkey_10/info/info_02.txt"
sc_ringkey_10_common = "ringkey_10/info/info_common_loops_02.txt"

# Küszöbértékes módszer
bin_all_avg_input = "binarization/thresholding/all_avg/info/info_02.txt"
bin_all_avg_common = "binarization/thresholding/all_avg/info/info_common_loops_02.txt"

bin_all_median_input = "binarization/thresholding/all_median/info/info_02.txt"
bin_all_median_common = "binarization/thresholding/all_median/info/info_common_loops_02.txt"

bin_row_avg_input = "binarization/thresholding/row_avg/info/info_02.txt"
bin_row_avg_common = "binarization/thresholding/row_avg/info/info_common_loops_02.txt"

bin_row_median_input = "binarization/thresholding/row_median/info/info_02.txt"
bin_row_median_common = "binarization/thresholding/row_median/info/info_common_loops_02.txt"

# Geometriai módszer
bin_geo_col_input = "binarization/geometric/column/info/info_02.txt"
bin_geo_col_common = "binarization/geometric/column/info/info_common_loops_02.txt"
bin_geo_row_input = "binarization/geometric/row/info/info_02.txt"
bin_geo_row_common = "binarization/geometric/row/info/info_common_loops_02.txt"
...
plt1.plot(ringkey_recall, ringkey_precision, 'o-r', label = ("ScanContext-50-with-RingKey" + "(AP=" + str(ringkey_ap) + ")"))
plt1.plot(ringkey_10_recall, ringkey_10_precision, 'o-g', label = ("ScanContext-10-with-RingKey" + "(AP=" + str(ringkey_10_ap) + ")"))
plt1.plot(bin_avg_all_recall, bin_avg_all_precision, 'o-k', label = ("Binarized-ScanContext-50-AVG-All" + "(AP=" + str(bin_avg_all_ap) + ")"))
plt1.plot(bin_median_all_recall, bin_median_all_precision, 'o-b', label = ("Binarized-ScanContext-50-MEDIAN-All" + "(AP=" + str(bin_median_all_ap) + ")"))
